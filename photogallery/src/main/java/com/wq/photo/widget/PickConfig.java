...
public class PickConfig {
    ...
    private PickConfig(Activity context, Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder actionBarcolor(int actionBarcolor) {
            this.actionBarcolor = actionBarcolor;
            return this;
        }

        public Builder isneedcrop(boolean isneed_crop) {
            this.isneed_crop = isneed_crop;
            return this;
        }

        public Builder isSqureCrop(boolean isSqureCrop) {
            this.isSqureCrop = isSqureCrop;
            return this;
        }

        public Builder isneedcamera(boolean isneed_camera) {
