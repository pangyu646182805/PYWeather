package com.neuroandroid.pyweather.widget.picker.lib;
...
import com.neuroandroid.pyweather.widget.picker.IPickerViewData;
import com.neuroandroid.pyweather.widget.picker.adapter.WheelAdapter;
import com.neuroandroid.pyweather.widget.picker.listener.LoopViewGestureListener;
import com.neuroandroid.pyweather.widget.picker.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (label != null) {
            ...
            //靠右并留出空隙
            if (context.getString(R.string.pickerview_hours).equals(label) || context.getString(R.string.pickerview_minutes).equals(label)) {
                canvas.drawText(label, drawRightContentStart - getResources().getDimension(R.dimen.x48), centerY, paintCenterText);
            } else if (context.getString(R.string.pickerview_day).equals(label) || context.getString(R.string.pickerview_month).equals(label)) {
                canvas.drawText(label, drawRightContentStart - getResources().getDimension(R.dimen.x24), centerY, paintCenterText);
            } else {
