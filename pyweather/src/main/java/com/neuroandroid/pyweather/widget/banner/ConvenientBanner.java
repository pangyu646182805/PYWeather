package com.neuroandroid.pyweather.widget.banner;
...
import com.neuroandroid.pyweather.widget.banner.adapter.CBPageAdapter;
import com.neuroandroid.pyweather.widget.banner.holder.CBViewHolderCreator;
import com.neuroandroid.pyweather.widget.banner.listener.CBPageChangeListener;
import com.neuroandroid.pyweather.widget.banner.listener.OnItemClickListener;
import com.neuroandroid.pyweather.widget.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        mRlBanner = (RelativeLayout) hView.findViewById(R.id.rl_banner);
        mRlBanner.setOnTouchListener(new OnTouchListener() {
            @Override
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding((int) getDimen(R.dimen.x16), 0, (int) getDimen(R.dimen.x16), 0);
