package com.neuroandroid.pyweather.widget.photo;
...
public interface IPhotoView {
    ...
    /**
     * RegisterUser a callback to be invoked when the Photo displayed by this view is long-pressed.
     *
    ...
    /**
     * RegisterUser a callback to be invoked when the Matrix has changed for this
    ...
    /**
     * RegisterUser a callback to be invoked when the Photo displayed by this View
    ...
    /**
     * RegisterUser a callback to be invoked when the View is tapped with a single
     * tap.
     *
     * @param listener - Listener to be registered.
     */
